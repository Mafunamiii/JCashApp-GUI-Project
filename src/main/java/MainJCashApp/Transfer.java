...
public class Transfer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        withdrawTField.setBackground(new java.awt.Color(224, 192, 151));
        withdrawTField.setFont(new java.awt.Font("Verdana", 0, 24)); // NOI18N
        withdrawTField.setForeground(new java.awt.Color(45, 36, 36));
        withdrawTField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                withdrawTFieldActionPerformed(evt);
            }
        });
        withdrawTField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                withdrawTFieldKeyPressed(evt);
            }
        });

        balanceLabel1.setFont(new java.awt.Font("Verdana", 0, 24)); // NOI18N
        balanceLabel1.setForeground(new java.awt.Color(224, 192, 151));
        balanceLabel1.setText("Remaining Balance: ");
        ...
        balanceLabel2.setFont(new java.awt.Font("Verdana", 0, 24)); // NOI18N
        balanceLabel2.setForeground(new java.awt.Color(224, 192, 151));
        balanceLabel2.setText("Bank Account Number: ");

        bankNum.setBackground(new java.awt.Color(224, 192, 151));
        bankNum.setFont(new java.awt.Font("Verdana", 0, 24)); // NOI18N
        bankNum.setForeground(new java.awt.Color(45, 36, 36));
        bankNum.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bankNumActionPerformed(evt);
            }
        });
        bankNum.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                bankNumKeyPressed(evt);
            }
        });
                ...
                .addGroup(mainMenuPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(mainMenuPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(mainMenuPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(withdrawTField, javax.swing.GroupLayout.PREFERRED_SIZE, 212, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(bankNum, javax.swing.GroupLayout.PREFERRED_SIZE, 212, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        mainMenuPanelLayout.setVerticalGroup(
            ...
            .addGroup(mainMenuPanelLayout.createSequentialGroup()
                .addGroup(mainMenuPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(bankNum, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(balanceLabel2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(11, 11, 11)
                .addGroup(mainMenuPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(withdrawTField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(mainMenuPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(balanceOutput, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(26, 26, 26)
                .addComponent(doneBtn)
                .addGap(62, 62, 62))
        );
    ...
    private void withdrawTFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_withdrawTFieldActionPerformed
        
    }//GEN-LAST:event_withdrawTFieldActionPerformed

    private void withdrawTFieldKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_withdrawTFieldKeyPressed
        char value = evt.getKeyChar();

        if (value >= KeyEvent.VK_0 && value <= KeyEvent.VK_9 || value == KeyEvent.VK_BACK_SPACE) {

            withdrawTField.setEditable(true);
        } else if ( value == KeyEvent.VK_ENTER ) {
            enteredAmount = Integer.valueOf(withdrawTField.getText());
            
            balanceOutput.setText(String.valueOf((accs.getAcct2().getSavings() - enteredAmount)));
            
        } else {
            withdrawTField.setEditable(false);
            JOptionPane.showMessageDialog(this, "Enter numbers 0-9 only");
        }
    }//GEN-LAST:event_withdrawTFieldKeyPressed

    private void bankNumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bankNumActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_bankNumActionPerformed

    private void bankNumKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_bankNumKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_bankNumKeyPressed
    ...
    private javax.swing.JTextField bankNum;
    ...
    private javax.swing.JTextField withdrawTField;
